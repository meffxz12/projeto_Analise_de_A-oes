...
import 'package:meu_apli/telas/configuraçao/alterar_senha_screen.dart';
import 'package:meu_apli/telas/configuraçao/editar_nome_screen.dart';

// ─── Tela de Editar Perfil ──────────────────────────────────────────────────
// Esta tela busca o perfil do usuário sozinha (igual a PerfilScreen faz)
// para poder passar o nome atual para a EditarNomeScreen.
...
class _EditarPerfilScreenState extends State<EditarPerfilScreen> {
  ...
  Future<void> _abrirEditarNome() async {
    ...
    final nomeAtual = _perfil!['name'] ?? _perfil!['nome'] ?? '';
    ...
    // Se o nome foi alterado lá dentro, recarrega o perfil aqui.
    if (atualizou == true) {
      _carregarPerfil();
    }
  }
