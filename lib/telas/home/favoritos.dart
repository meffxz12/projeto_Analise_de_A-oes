...
class _FavoritosScreenState
  ...
  Future<void> _carregar() async {
    ...
    try {
      ...
      final fundos =
          await ApiService.listarFavoritosFundos();
  ...
  Future<void> _removerFundo(
    String codigo,
  ) async {
    try {
      await ApiService.removerFavoritoFundo(
        codigo,
      );
